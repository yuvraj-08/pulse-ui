  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 transition-colors duration-300 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <footer className="border-t border-black/[0.06] dark:border-white/[0.06] py-8">
        <div className="mx-auto max-w-6xl px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-400">
          <span>Built with Next.js 16 · Framer Motion v12 · Tailwind v4</span>
          <Link
            href="https://github.com/yuvraj-08"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-zinc-500 hover:text-violet-500 dark:hover:text-violet-400 transition-colors duration-200 font-medium"
          >
            ...
            Designed & built by Yuvraj Singh
          </Link>
        </div>
      </footer>
    </div>
